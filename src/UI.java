...
public class UI extends JPanel
{
    ...
    public UI(int x, int y, int _size)
    {
        ...
        window = new JFrame("Game of LIUfe");
    ...
    private Color GetColorOfID(int i)
    {
        ...
        else if(i==1) {return Color.BLACK;}
        ...
        else if(i==7) {return new Color(255, 194, 10);}
        else if(i==8) {return new Color(100, 80, 29);}
        else if(i==9) {return new Color(0, 0, 100);}
        else if(i==10) {return new Color(12,123,220);}
